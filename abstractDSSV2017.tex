...
\bibitem{journal01} J. Kujawiak (2001). \emph{A selection of best hypothesis}. Recent trends in Visualization, 12(4):1--6.

\bibitem{book98}
L.~R. Ojapali, P.~Q. Rock, and S.~T. Upa (1998). \emph{Concrete Data}. Editor-Name, City.

\bibitem{procc11} V. Waltz (2011). \emph{Two notes on Best Hypothesis}. In DSSV0000, Lisbon, 403--422.
\end{thebibliography}
